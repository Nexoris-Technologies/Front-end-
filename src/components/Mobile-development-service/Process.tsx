    ...
    <section>
      <div className="flex flex-col gap-[40px] py-[3rem] lg:py-[6rem]">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-5 gap-[1rem]   mx-auto lg:w-300">
          ...
          {/* Fourth card */}
          <div className="flex flex-col order-6 md:order-0 items-center gap-[24px] w-[288px]">
            <div className="w-[48px] h-[48px] md:w-[56px] md:h-[56px]">
              <Image
                src="/Tennis bat.svg"
                alt="Tennis"
          ...
          {/* Fifth card */}
          <div className="flex flex-col order-5 md:order-0 items-center gap-[24px] w-[288px] col-span-1">
            <div className="w-[48px] h-[48px] md:w-[56px] md:h-[56px]">
              <Image
                src="/Tennis bat.svg"
                alt="Tennis"
