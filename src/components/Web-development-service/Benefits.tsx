...
function Benefits() {
  return (
    <section className="px-4">
      <div className="flex flex-col items-center gap-10 py-14 lg:py-28 max-w-7xl mx-auto">
          ...
          {[
            {
              ...
              description: "Sub-2-second load times for better UX and SEO rankings.",
            },
            {
              icon: "/Scalable.svg",
            ...
            },
            {
              ...
              description: "Schema, semantic HTML, and Core Web Vitals baked in.",
            },
            {
              icon: "/Perfect.svg",
              title: "Perfect on Every Screen",
              description: "Mobile-first, responsive, and fluid across devices.",
            },
          ].map((item, index) => (
            <div
              key={index}
              className="flex flex-col items-center justify-center gap-4 border border-[#898686] rounded-md px-4 py-6 text-center w-full max-w-sm mx-auto"
            >
