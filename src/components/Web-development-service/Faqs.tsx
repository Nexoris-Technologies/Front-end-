...
const getItems = (panelStyle) => [
  ...
  {
    key: '2',
    label: <span className='font-bold text-lg sm:text-xl text-[#543CDA]'>How fast can you build a website?</span>,
    children: <p className='text-[#543CDA] font-medium text-sm sm:text-base'>{text}</p>,
    style: panelStyle,
  },
  {
    key: '3',
    label: <span className='font-bold text-lg sm:text-xl text-[#543CDA]'>Do you offer redesigns or modernizations?</span>,
    children: <p className='text-[#543CDA] font-medium text-sm sm:text-base'>{text}</p>,
    style: panelStyle,
  },
  {
    key: '4',
    label: <span className='font-bold text-lg sm:text-xl text-[#543CDA]'>What’s the average cost of a project?</span>,
    children: <p className='text-[#543CDA] font-medium text-sm sm:text-base'>{text}</p>,
    style: panelStyle,
  },
  {
    key: '5',
    label: <span className='font-bold text-lg sm:text-xl text-[#543CDA]'>Can I manage the site myself after launch?</span>,
    children: <p className='text-[#543CDA] font-medium text-sm sm:text-base'>{text}</p>,
    style: panelStyle,
  },
];
