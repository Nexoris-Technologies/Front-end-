            ...
            <div className="flex-1 rounded-[16px] h-[700px] order-1 md:order-1 border border-[#D9D9D9] bg-[#D9D9D9]/4 p-6 flex flex-col gap-8">
              ...
              <div className="flex flex-col gap-4">
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  ...
                  <div className="flex-1 flex flex-col gap-2">
                    <label htmlFor="Last Name">{typeof errors.lastname?.message !== "undefined"?`${errors.lastname?.message}`:`Last Name`}</label>
                    <input
                      id="Last Name"
                      type="text"
                      className="border border-[#8F9092]/40 px-3 py-2 rounded"
                ...
                <div className="flex flex-col md:flex-row gap-4">
                  <div className="flex-1 flex flex-col gap-2">
                    <label htmlFor="Email">{typeof errors.email?.message !== "undefined"?`${errors.email?.message}`:`Email`}</label>
                    <input
                      id="Email"
                      type="email"
                      className="border border-[#8F9092]/40 px-3 py-2 rounded"
                  ...
                  <div className="flex-1 flex flex-col gap-2">
                    <label>{typeof errors.phonenumber?.message !== "undefined"?`${errors.phonenumber?.message}`:`Phone Number`}</label>
                    <input
                      type="text"
                      placeholder="+234"
                      className="border border-[#8F9092]/40 px-3 py-2 rounded"
                ...
                {/* Subject Select */}
                <div className="flex flex-col gap-2">
                  <label htmlFor="Select Subject">{(typeof errors._subject?.message !== "undefined" || watch("_subject")==="Select a subject")?`${errors._subject?.message}`:`Select Subject`}</label>
                ...
                {/* Message Textarea */}
                <div className="flex flex-col gap-2">
                  <label htmlFor="Message">{typeof errors.message?.message !== "undefined"?`${errors.message?.message}`:`Message`}</label>
                  <textarea
                    id="Message"
