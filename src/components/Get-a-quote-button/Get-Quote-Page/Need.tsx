          ...
          <div className="flex flex-col gap-[24px]  ">
            ...
            <div className="flex flex-col md:flex-row gap-[24px]">
              ...
              <div className="flex flex-col gap-[8px] flex-1">
                <label htmlFor="Full name" className="text-[16px] ">
                  {typeof errors.fullname?.message !== "undefined"?`${errors.fullname?.message}`:`Full Name`}
                </label>
                <input
                  id="Full name"
                  type="text"
                  ...
                  {...register("fullname",{
                      ...
                      validate:{
                          fullNameLength: (fieldValue)=>(
                              fieldValue.length >= 3 || 'Full Name must be at least 3 character long'
                          )
                      }
                  })}
                />
              ...
              <div className="flex flex-col gap-[8px] flex-1">
                <label htmlFor="Email" className="text-[16px] ">
                  {typeof errors.email?.message !== "undefined"?`${errors.email?.message}`:`Email`}
                </label>
                <input
                  id="Email"
                  type="email"
            ...
            <div className="flex flex-col gap-[8px] ">
              <label htmlFor="Company name" className="text-[16px] ">
                {typeof errors.companyname?.message !== "undefined"?`${errors.companyname?.message}`:`Company Name`}
              </label>
              <input
                id="Company name"
                type="text"
                  ...
                  disabled: watch("email") === "",
                    ...
                    validate:{
                        companyNameLength: (fieldValue)=>(
                            fieldValue.length >= 3 || 'Company Name must be at least 3 character long'
                        )
                    }
                })}
              />
            ...
            <div className="flex flex-col gap-[8px]">
              <label htmlFor="Solution" className="text-[16px] ">
                {typeof errors.solution?.message !== "undefined"?`${errors.solution?.message}`:`What solution are you exploring today?`}
              </label>
            ...
            <div className="flex flex-col gap-[8px]">
              <label htmlFor="Time Zone" className="text-[16px] ">
                {(typeof errors.timezone?.message !== "undefined" || watch("timezone")==="Select your Time zone")?`${errors.timezone?.message}`:`Timezone`}
              </label>
              <div className="relative">
                <select
                  {...register("timezone",{
            ...
            <div className="flex flex-col gap-2">
              <label>
                {(typeof errors.description?.message !== "undefined" || watch("description")==="")?`${errors.description?.message}`:`Product Description / Goals`}
              </label>
              <textarea
            ...
            <div className="  flex justify-center items-center">
              <button type="submit" disabled={!isDirty || !isValid || isSubmitting} className="bg-[#543CDA] text-white font-bold text-[16px] px-6 py-3 md:py-4 md:px-10 rounded mt-3  flex items-center gap-4">
