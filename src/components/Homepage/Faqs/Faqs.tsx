...
const getItems = (panelStyle) => [
  {
    key: '1',
    label: <span className='font-bold text-lg sm:text-xl'>How long does it take to build?</span>,
    children: <p className='text-[#543CDA] font-medium text-sm sm:text-base'>{text}</p>,
    style: panelStyle,
  },
  {
    key: '2',
    label: <span className='font-bold text-lg sm:text-xl'>Can you work with what we already have?</span>,
    children: <p className='text-[#543CDA] font-medium text-sm sm:text-base'>{text}</p>,
    style: panelStyle,
  },
  {
    key: '3',
    label: <span className='font-bold text-lg sm:text-xl'>Will we be able to manage things ourselves?</span>,
    children: <p className='text-[#543CDA] font-medium text-sm sm:text-base'>{text}</p>,
    style: panelStyle,
  },
  {
    key: '4',
    label: <span className='font-bold text-lg sm:text-xl'>Do you work with global teams?</span>,
    children: <p className='text-[#543CDA] font-medium text-sm sm:text-base'>{text}</p>,
    style: panelStyle,
  },
  {
    key: '5',
    label: <span className='font-bold text-lg sm:text-xl'>How much will it cost?</span>,
    children: <p className='text-[#543CDA] font-medium text-sm sm:text-base'>{text}</p>,
    style: panelStyle,
  },
];
