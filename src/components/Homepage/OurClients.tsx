...
const testimonials = [
  ...
  },
  {
    ...
    quote:
      "Our site used to take 9 seconds to load. Nexoris rebuilt everything. Now under 2s, conversions tripled.",
  },
  {
    name: "Maria O.",
    ...
    quote:
      "Crashes were a daily thing. Support tickets piled up. Now users are sending compliments.",
  },
  {
    name: "Tunde K.",
    role: "CEO, PayFleet",
    ...
    quote:
      "Our mobile app no longer crashes under peak traffic. Nexoris changed the game.",
  },
  {
    name: "Esther N.",
    ...
    quote:
      "We scaled from MVP to platform fast. Clean execution, clear communication, solid results.",
  },
];
...
const TestimonialCard = ({ testimonial }: { testimonial: Testimonial }) => (
  ...
  >
    ...
    <div className="flex flex-col items-center gap-1">
      <h3 className="text-primary-purple font-bold text-base sm:text-lg">
        {testimonial.name}
      </h3>
      <p className="text-purple-dark text-sm sm:text-base font-medium">
        {testimonial.role}
      </p>
    </div>

    <p className="text-purple-dark text-sm sm:text-base leading-relaxed max-w-xs my-4">
      {testimonial.quote}
    </p>

    <div
      className="flex justify-center text-primary-purple"
...
export default function TestimonialCarousel() {
  return (
    <section
      className="container max-w-[75rem] mx-auto px-4 sm:px-6 lg:px-8 py-20"
