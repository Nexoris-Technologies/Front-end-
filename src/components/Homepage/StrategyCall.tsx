...
export default function StrategyCall() {
  return (
    ...
    >
      <div className="w-full  bg-gradient-to-br from-[#EAE8F7] via-[#F6F4FF] to-[#FFFFFF] rounded-xl flex flex-col items-center justify-center gap-8 md:gap-16 lg:gap-10 py-6 px-4 sm:px-8 md:py-10 lg:py-18 shadow-sm">
        <h2
        ...
        >
          You&rsquo;ve Been Thinking About This for Months, Let&rsquo;s Finally
          Build It Right
        </h2>
        ...
        <p className="font-medium text-center text-sm sm:text-base max-w-2xl text-purple-dark">
          ...
          Now it&rsquo;s time to bring it to life with a team that gets it,
          builds fast, and stays for the long haul.
        </p>
        ...
        <p className="font-medium text-center text-sm sm:text-base px-2 sm:px-0 text-purple-dark max-w-xl">
          No pressure. No fluff. Just real help, from people who&rsquo;ve built
