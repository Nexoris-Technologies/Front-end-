...
export default function Hero() {
  return (
    <><section className="bg-purple-6 w-full overflow-hidden" aria-label="Hero Section">
          ...
          <div className="flex flex-col lg:flex-row justify-between items-center gap-[60px] md:gap-[24px] py-20 mx-auto w-full">
            ...
            <div className="flex-1 flex flex-col justify-center gap-[40px] md:gap-[90px] container mx-auto">
              ...
              <div className="flex flex-col-reverse md:flex-row lg:block gap-x-12 items-center content-center">
                <Link href="/contact-us" className="w-fit mt-12 md:mt-0 lg:h-auto rounded-lg py-3 lg:py-5 px-4 lg:px-8 flex items-center justify-center bg-primary-purple hover:bg-primary-blue mx-auto md:mx-0 leading-[100%] tracking-wide text-purple-6 cursor-pointer font-medium">
                ...
                <div className="flex flex-col justify-center gap-y-4 md:gap-x[12px] mt-4">
                  ...
                  <div className="flex gap-x-4 md:gap-x-15 items-center mt-2">
                    <div className="flex flex-col">
                      <h2 className="text-base lg:text-xl font-bold">3-seconds</h2>
                      <p className="text-sm text-purple-dark">Average Load Time</p>
                    </div>
                    <div className="flex flex-col">
                      <h2 className="text-base lg:text-xl font-bold">+40%</h2>
                      <p className="text-sm text-purple-dark">SEO uplift</p>
                    </div>
                    <div className="flex flex-col">
                      <h2 className="text-base lg:text-xl font-bold">Zero-crash</h2>
                      <p className="text-sm text-purple-dark">Mobile apps</p>
                    </div>
                  </div>
                </div>
                </div>
            ...
            <div className="relative flex-1 flex justify-center items-center">
              ...
              <div className="relative w-full">
                <Image src="/Hero-image.webp" alt="Hero image" width={695} height={369} className="w-full h-auto" />
                <div className="hidden absolute -top-[5%] left-[55%] md:-top-[1%] md:left-[48%] transform -translate-y-1/2 w-[160px] h-[3rem] lg:w-[220px] xl:w-[280px] md:h-[106px] rounded-[20px] bg-white lg:flex flex-col items-center justify-center gap-[10px] px-[19px] py-[7px] md:py-[15px]">
                  <Image src="/shield-check--shield-protection-security-defend-crime-war-cover-check.svg" alt="Shield check" width={15} height={16} className="absolute top-[12px] md:top-[14px] left-1/2 transform -translate-x-1/2 text-[#543CDA]" />
                  <p className="text-[7px] md:text-[12px] leading-[10px] md:leading-[15px] tracking-widest text-center mt-[2rem]">
                    Nexoris is 100% Tested and Trusted and we will take your dreams and build something
                  </p>
                  <div className="absolute left-[-12%] md:-left-[27px] top-[40px] rotate-[-8deg]">
                    <Image src="/cursor-arrow-1.svg" alt="Cursor arrow" width={37.63} height={37.38} />
                  </div>
                </div>
                <div className="hidden absolute top-[100%] md:top-[100%] -left-[2%] md:left-[-8%] -translate-y-1/2 w-[10rem] h-[5rem] md:w-[335px] md:h-[7rem] bg-white rounded-[1rem] px-[1rem] py-0.5 md:p-4 lg:flex flex-col gap-0.5">
                  <p className="text-[7px] md:text-[11px] leading-[10px] md:leading-[14px] text-[#080C11]">
                    &quot;Before Nexoris, we were constantly patching bugs and bleeding traffic. They rebuilt our site from scratch. Now we rank in Google&#39;s top 7. And conversions? Tripled.&quot;
                  </p>
                  <div className="flex items-center gap-x-0.5">
                    <Image src="/Ellipse1.webp" alt="Client image" width={40} height={40} className="rounded-full w-[1.5rem] h-[1.5rem] md:w-[2.5rem] md:h-[2.5rem]" />
                    <div className="flex flex-col justify-center">
                      <p className="text-[6px] md:text-[12px] mt-2 font-semibold text-[#000]">Damilola E.</p>
                      <p className="text-[7px] md:text-[11px] leading-[10px] md:leading-[30px] tracking-tight">CTO, Medirect</p>
                    </div>
                  </div>
                  <div className="absolute -left-[8%] md:left-[-8%] top-[60%] md:top-[50%] rotate-[-8deg]">
                    <Image src="/cursor-arrow 2.svg" alt="Cursor arrow 2" width={37.2} height={37.02} className="w-[25px] h-[25px] md:w-[37.2px] md:h-[37.2px]" />
                  </div>
                </div>
              </div>
            </div>
     ...
     {/* Client Logos */}
    <div className="hidden absolute shadow-purple-dark left-0 right-0 shadow bottom-[50%] xl:bottom-[-8%] translate-y-1/2 z-5 py-4 bg-white rounded-lg overflow-hidden w-[75%] mx-auto h-20 lg:flex items-center content-center">
        <LogoMarquee />
      </div></>
  );
}
