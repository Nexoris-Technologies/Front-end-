...
function Ourprocess() {
  return (
<<<<<<< HEAD:src/components/Homepage/OurProcess/OurProcess.tsx
...
>>>>>>> origin/master:src/components/common/HomePage/OurProcess/OurProcess.tsx
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-4 lg:gap-2 w-full">
          ...
          <div className="flex flex-col items-center text-center gap-4 w-full">
            <div className="bg-white w-24 h-24 md:h-36 md:w-36 rounded-full flex items-center justify-center">
              <h1 className="text-[#543CDA] font-bold text-3xl md:text-8xl">01</h1>
            </div>
<<<<<<< HEAD:src/components/Homepage/OurProcess/OurProcess.tsx
...
>>>>>>> origin/master:src/components/common/HomePage/OurProcess/OurProcess.tsx
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-8 md:gap-4 lg:gap-2">
          <div className="flex flex-col items-center text-center gap-4 w-full md:w-1/2">
            <div className="bg-white w-24 h-24 md:h-36 md:w-36 rounded-full flex items-center justify-center">
              <h1 className="text-[#543CDA] font-bold text-3xl md:text-8xl">02</h1>
            </div>
<<<<<<< HEAD:src/components/Homepage/OurProcess/OurProcess.tsx
            <h4 className="text-[#543CDA] font-medium text-xl md:text-2xl">A Clear Blueprint</h4>
            <p className="text-base md:text-lg font-medium max-w-md">
              No bloated proposals or fuzzy estimates. You&#39;ll get a straight-up plan: stack, timeline, pricing crystal clear from day one.
=======
            <h4 className="text-[#543CDA] font-medium text-xl md:text-2xl">
              A Clear Blueprint
            </h4>
...
>>>>>>> origin/master:src/components/common/HomePage/OurProcess/OurProcess.tsx
        ...
        <div className="flex flex-col md:flex-row items-center justify-center gap-8 md:gap-4 lg:gap-2">
          ...
          <div className="flex flex-col items-center text-center gap-4 w-full md:w-1/2">
            <div className="bg-white w-24 h-24 md:h-36 md:w-36 rounded-full flex items-center justify-center">
              <h1 className="text-[#543CDA] font-bold text-3xl md:text-8xl">03</h1>
            </div>
<<<<<<< HEAD:src/components/Homepage/OurProcess/OurProcess.tsx
            <h4 className="text-[#543CDA] font-medium text-xl md:text-2xl">Build, Sprint, Review</h4>
            <p className="text-base md:text-lg font-medium max-w-md">
              You meet your team. We work in focused sprints with regular check-ins, honest updates, and work that speaks for itself.
=======
            <h4 className="text-[#543CDA] font-medium text-xl md:text-2xl">
              Build, Sprint, Review
            </h4>
...
>>>>>>> origin/master:src/components/common/HomePage/OurProcess/OurProcess.tsx
        ...
        <div className="flex flex-col-reverse md:flex-row items-center justify-center gap-8 md:gap-4 lg:gap-2">
          <div className="flex flex-col items-center text-center gap-4 w-full md:w-1/2">
            <div className="bg-white w-24 h-24 md:h-36 md:w-36 rounded-full flex items-center justify-center">
              <h1 className="text-[#543CDA] font-bold text-3xl md:text-8xl">04</h1>
            </div>
<<<<<<< HEAD:src/components/Homepage/OurProcess/OurProcess.tsx
            <h4 className="text-[#543CDA] font-medium text-xl md:text-2xl">Launch and Keep Growing</h4>
            <p className="text-base md:text-lg font-medium max-w-md">
              We don&#39;t ghost after go-live. We test, refine, and scale with you, turning early momentum into long-term success.
=======
            <h4 className="text-[#543CDA] font-medium text-xl md:text-2xl">
