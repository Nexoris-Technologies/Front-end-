    ...
    <section className="bg-[#EAE8F7] py-32 w-full flex flex-col items-center justify-center gap-8 mt-10">
      ...
      <section className="flex flex-col lg:flex-row justify-between items-center gap-10 container mx-auto px-4 lg:px-40">
        ...
        <div className="flex flex-col items-center justify-center px-6 pb-8 gap-4 w-[421px] h-[405px] max-w-md bg-white shadow-2xl rounded-md">
          ...
          <h3 className="font-bold text-[25px] text-[#543CDA] text-center">
            Startups & Founders
          </h3>
        ...
        <div className="flex flex-col items-center justify-center px-6 pb-8 gap-4 w-[421px] h-[405px] max-w-md bg-white shadow-2xl rounded-md">
          ...
          <p className="text-center w-[336px]">
            Your business is scaling and your tech needs to keep up. We help
            growing teams modernize their systems, automate workflows, and build
            tools that support the next stage of growth.
          </p>
        </div>
      </section>
      ...
      <div className="flex flex-col items-center justify-center my-12 px-4 text-center">
        ...
        <p className="font-[400] text-[18px] w-[370px]">
          ...
          industries and stages of growth. While each client is unique, most
      ...
      <section className="flex flex-col lg:flex-row justify-between items-center gap-10 container mx-auto px-4 lg:px-40">
        ...
        <div className="flex flex-col items-center justify-center px-6 pb-8 gap-4 w-[421px] h-[405px] max-w-md bg-white shadow-2xl rounded-md">
          ...
          <h3 className="font-bold text-[25px] text-[#543CDA] text-center">
            Agencies, Consultants & Partners
          </h3>
          <p className="text-center w-[310px] font-[400]">
            You serve your own clients and need a reliable tech team to back you
            up. We collaborate behind the scenes to deliver white-label
            development, co-branded apps, and seamless handovers.
          </p>
        </div>
        ...
        <div className="flex flex-col items-center justify-center px-6 pb-8 gap-4 w-[421px] h-[405px] max-w-md bg-white shadow-2xl rounded-md">
          ...
          <p className="text-center w-[310px] font-[400]">
            You need custom, secure, and scalable solutions to support
            operations at scale. We bring technical expertise, design clarity,
            and long-term support to complex digital transformations.
          </p>
        </div>
      </section>
      ...
      <div className="flex flex-col items-center justify-center mt-16 px-4 text-center">
        <h1 className="font-bold text-[25px] text-[#543CDA]">
