...
const getItems = (panelStyle) => [
  ...
  {
    key: '2',
    label: <span className='font-bold text-lg sm:text-xl text-[#543CDA]'>Do you offer standalone design audits?</span>,
    children: <p className='text-[#543CDA] font-medium text-sm sm:text-base'>{text}</p>,
    style: panelStyle,
  },
  {
    key: '3',
    label: <span className='font-bold text-lg sm:text-xl text-[#543CDA]'>How long does a typical design engagement take?</span>,
    children: <p className='text-[#543CDA] font-medium text-sm sm:text-base'>{text}</p>,
    style: panelStyle,
  },
  {
    key: '4',
    label: <span className='font-bold text-lg sm:text-xl text-[#543CDA]'>Can you design and hand off in Figma?</span>,
    children: <p className='text-[#543CDA] font-medium text-sm sm:text-base'>{text}</p>,
    style: panelStyle,
  },
  {
    key: '5',
    label: <span className='font-bold text-lg sm:text-xl text-[#543CDA]'>Do you offer branding too?</span>,
    children: <p className='text-[#543CDA] font-medium text-sm sm:text-base'>{text}</p>,
    style: panelStyle,
  },
];
