...
export default function ProblemWeSolve() {
  return (
    <section className="py-[1rem] lg:py-[7rem]">
      <h3 className="text-[24px] md:text-[40px] font-bold text-center mb-[2rem]">
        Problem We Solve
      </h3>

      {/* DESKTOP STATIC VIEW: Visible from md and up */}
      <div className="hidden md:grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-5 gap-[24px] mx-auto max-w-[1224px]">
        {/* First card */}
